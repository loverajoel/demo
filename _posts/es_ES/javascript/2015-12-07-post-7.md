...
Inserting an item into an existing array is a daily common task. You can add elemes_ESts to the end of an array using push, to the beginning using unshift, or to the middle using splice.
